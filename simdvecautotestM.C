...
int main(int argc, char *argv[])
{
  ...
  TestAll<TesterMaskUnary, SW, Mask_ceil>::test(repeats1, pattern);
  TestAll<TesterMaskZUnary, SW, MaskZ_ceil>::test(repeats1, pattern);
  TestAll<TesterMaskUnary, SW, Mask_floor>::test(repeats1, pattern);
  TestAll<TesterMaskZUnary, SW, MaskZ_floor>::test(repeats1, pattern);
  TestAll<TesterMaskUnary, SW, Mask_round>::test(repeats1, pattern);
  TestAll<TesterMaskZUnary, SW, MaskZ_round>::test(repeats1, pattern);
  TestAll<TesterMaskUnary, SW, Mask_truncate>::test(repeats1, pattern);
  TestAll<TesterMaskZUnary, SW, MaskZ_truncate>::test(repeats1, pattern);
...
#endif
  TestAll<TesterMaskUnary, SW, Mask_abs>::test(repeats1, pattern);
  TestAll<TesterMaskZUnary, SW, MaskZ_abs>::test(repeats1, pattern);
  ...
  TestIntTI<TesterMaskZUnaryTIMinToMax, SW, MaskZ_srai>::test(repeats1,
                                                              pattern);
  TestIntTI<TesterMaskUnaryTIMinToMax, SW, Mask_srli>::test(repeats1, pattern);
  TestIntTI<TesterMaskZUnaryTIMinToMax, SW, MaskZ_srli>::test(repeats1,
                                                              pattern);
  TestIntTI<TesterMaskUnaryTIMinToMax, SW, Mask_slli>::test(repeats1, pattern);
  TestIntTI<TesterMaskZUnaryTIMinToMax, SW, MaskZ_slli>::test(repeats1,
                                                              pattern);
